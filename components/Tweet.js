...
import { formatStr } from "../lib/formatString";
...
export default function Tweet({
  ...
  return (
    <div className="tweet rounded-lg border border-gray-200 dark:border-gray-800 px-6 py-4 my-4 w-full">
      ...
      <div className="mt-4 mb-1 leading-normal whitespace-pre-wrap text-lg">
        {formatStr(text)}
      </div>
      {media && media.length ? (
        <div
